...
describe('ChangeUnitFilter', () => {
  ...
  describe('should properly process', () => {
    ...
    it('string instead of a number', () => {
      ...
      let result = $filter('changeUnit')(input, ['B', 'GB']);
    ...
    it('unexpected unit type', () => {
      ...
      let result = $filter('changeUnit')(input, ['B', unknownUnit]);
  ...
  describe('should convert B to', () => {
    ...
    it('KB', () => {
      ...
      let result = $filter('changeUnit')(number, [unitFrom, unitTo]);
